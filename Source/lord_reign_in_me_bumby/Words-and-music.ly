...
SongNumber = \lord_reign_in_me_bumby_number
...
number_on_rhs = \lord_reign_in_me_bumby_number_rhs

FirstPage = #(if lord_reign_in_me_bumby_number_rhs 1 2)
...
\header {
  ...
  lhs = #(if lord_reign_in_me_bumby_number_rhs LeaderHints lord_reign_in_me_bumby_number)
  rhs = #(if lord_reign_in_me_bumby_number_rhs lord_reign_in_me_bumby_number LeaderHints)
  meter = "Irregular"
  poet = "Brenton Brown"
  translator = ##f
