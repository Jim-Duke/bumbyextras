...
SongNumber = \listen_to_our_hearts_number
LeaderHints = \markup {
  \fontsize #-4
  \normal-text { "F - 4 - MI" }
}
number_on_rhs = \listen_to_our_hearts_number_rhs
FirstPage = #(if listen_to_our_hearts_number_rhs 1 2)
...
\header {
  ...
  license = #(string-append "CCLI Song #903151, License #" ccli_license)
  tagline = ##f
}
