...
bumby_ccli_license = "2055442"

% Songs
% Comment out when building for other groups

% B-001
my_shepherd_will_supply_my_need_bumby_number = "B-001"
my_shepherd_will_supply_my_need_bumby_number_rhs = ##t
my_shepherd_will_supply_my_need_bumby_pages = #1

% B-002
teach_me_lord_to_wait_bumby_number = "B-002"
teach_me_lord_to_wait_bumby_number_rhs = ##f
teach_me_lord_to_wait_bumby_pages = #2

% B-003
in_christ_alone_bumby_number = "B-003"
in_christ_alone_bumby_number_rhs = ##f
in_christ_alone_bumby_pages = 1

% B-004
% Abide With Me - One Page
abide_with_me_bumby_number = "B-004"
abide_with_me_bumby_number_rhs = ##t
abide_with_me_bumby_pages = 1
