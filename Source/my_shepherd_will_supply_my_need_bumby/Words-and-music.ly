...
SongNumber = \my_shepherd_will_supply_my_need_bumby_number
...
FirstPage = #(if my_shepherd_will_supply_my_need_bumby_number_rhs 1 2)
...
\header {
  ...
  lhs = #(if my_shepherd_will_supply_my_need_bumby_number_rhs LeaderHints my_shepherd_will_supply_my_need_bumby_number)
  rhs = #(if my_shepherd_will_supply_my_need_bumby_number_rhs my_shepherd_will_supply_my_need_bumby_number LeaderHints)
