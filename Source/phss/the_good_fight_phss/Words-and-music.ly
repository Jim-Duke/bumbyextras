...
SongNumber = \the_good_fight_phss_number
RightFirstPage = \the_good_fight_phss_number_rhs
FirstPage = #(if RightFirstPage 1 2)

LeaderHints = \markup {
  \fontsize #-4
  \normal-text { "A (F" \musicglyph #"accidentals.sharp" "m) - 4 - LA" }
}
...
\header {
  title = \Title
  tune = "KINGSFOLD-COUNTY DOWN"
  meter = "CMD"
  composer = "Broadwood and Fuller-Maitland's English County Songs (1893)"
  arranger = "Ralph Vaughn Williams (1906), recast C. A. Roberts (2012)"
