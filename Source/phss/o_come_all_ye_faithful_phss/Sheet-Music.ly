    ...
    \context ChoirStaff <<
      ...
      \context Staff = upper <<
        \partCombine
          {
            \global
            \partial 4 \keepWithTag #'sheetMusic \SopranoVerseMusic
          }
          {
            \global
            \partial 4 \keepWithTag #'sheetMusic \AltoVerseMusic
          }
        ...
        \context NullVoice = alignOne {
          \global
          \partial 4 \keepWithTag #'verseOne \AlignVerseMusic
        }
        \context NullVoice = alignTwo {
          \global
          \partial 4 \keepWithTag #'verseTwo \AlignVerseMusic
        }
        \context NullVoice = alignThree {
          \global
          \partial 4 \keepWithTag #'verseThree \AlignVerseMusic
        }
      ...
      \context Staff = lower <<
        ...
        \partCombine
          {
            \global
            \partial 4 \keepWithTag #'sheetMusic \TenorVerseMusic
          }
          {
            \global
            \partial 4 \keepWithTag #'sheetMusic \BassVerseMusic
          }
      >>
    >>
    ...
    \context ChoirStaff <<
      ...
      \context Staff = upper <<
        \partCombine
          {
            \global
            \partial 4 \SopranoRefrainMusic
          }
          {
            \global
            \partial 4 \AltoRefrainMusic
          }
        \context NullVoice = breaks {
          \global
          \partial 4 \SheetMusicRefrainBreaks
        }
        \context NullVoice = align {
          \global
          \partial 4 \AlignRefrainMusic
        }
      ...
      \context Staff = lower <<
        ...
        \partCombine
          {
            \global
            \partial 4 \TenorRefrainMusic
          }
          {
            \global
            \partial 4 \BassRefrainMusic
          }
      >>
    >>
    \SheetMusicVerseLayout
