...
SongNumber = \my_god_i_thank_you_who_have_made_phss_number
RightFirstPage = \my_god_i_thank_you_who_have_made_phss_number_rhs
...
VerseThree = \lyricmode {
  ...
  That shad -- ows fall on bright -- est hours.
  That thorns re -- main;
