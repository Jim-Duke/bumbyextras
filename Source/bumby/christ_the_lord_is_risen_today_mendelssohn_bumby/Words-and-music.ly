...
SongNumber = \christ_the_lord_is_risen_today_mendelssohn_bumby_number
...
FirstPage = #(if christ_the_lord_is_risen_today_mendelssohn_bumby_number_rhs 1 2)
...
\header {
  ...
  lhs = #(if christ_the_lord_is_risen_today_mendelssohn_bumby_number_rhs LeaderHints christ_the_lord_is_risen_today_mendelssohn_bumby_number)
  rhs = #(if christ_the_lord_is_risen_today_mendelssohn_bumby_number_rhs christ_the_lord_is_risen_today_mendelssohn_bumby_number LeaderHints)
