    ...
    \context ChoirStaff <<
      ...
      \context Staff = upper \with { printPartCombineTexts = ##f } <<
        ...
        \context NullVoice = alignA {
          \global
          \keepWithTag #'usePartials \AlignChorusA
        }
        \context NullVoice = alignB {
          \global
          \keepWithTag #'usePartials \AlignChorusB
        }
      ...
      \context Staff = lower \with { printPartCombineTexts = ##f } <<
        ...
        \context NullVoice ="alignC" {
          \global
          \keepWithTag #'usePartials \AlignChorusC
        }
        \new Lyrics \lyricsto "alignC" {
          \ChorusC
        }
      >>
    >>
