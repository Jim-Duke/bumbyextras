...
\book {
  ...
  \score {
    \new ChoirStaff <<
      ...
      \new Staff \with { instrumentName = \markup { "Soprano" \fontsize #2 \circle { 2 } \hspace #1 } } <<
        \new Voice = "sopranos" {
          \global
      ...
      \new Staff \with { instrumentName = \markup { "Alto" \fontsize #2 \circle { 1 } \hspace #1 } } {
        \new Voice = "altos" {
          \global
      ...
      \new Staff  \with { instrumentName = \markup { "Tenor" \fontsize #2 \circle { 3 } \hspace #1 } } {
        \new Voice = "tenors" {
          \clef bass
          \global
      ...
      \new Staff  \with { instrumentName = \markup { "Bass" \fontsize #2 \circle { 4 } \hspace #1 } } {
        \new Voice = "basses" {
          \clef bass
          \global
